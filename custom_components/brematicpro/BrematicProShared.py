...
async def async_common_setup_entry(hass, entry, async_add_entities, entity_class):
    ...
    if json_data:
        ...
        entities = []
        device_registry = await hass.helpers.device_registry.async_get(hass)#await hass.helpers.device_registry.async_get_registry()
        entity_registry = await hass.helpers.entity_registry.async_get(hass)#await hass.helpers.entity_registry.async_get_registry()
