...
from .BrematicProShared import read_and_transform_json, unload_entry_components, BrematicProJsonDownloadView, BrematicProCoordinator
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    setup_entry_components(hass, entry)
    
    return True


async def setup_entry_components(hass, entry):
