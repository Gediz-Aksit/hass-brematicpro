    ...
    async def common_flow_handler(self, user_input):
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "brematic_system_code": "Your system's unique code",
                "brematic_config_json": "Path to the configuration JSON file",
                "brematic_rooms_json": "Path to the rooms JSON file",
...
class BrematicProOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_init(self, user_input=None):
        """Manage the options."""
        return await BrematicProConfigFlow.common_flow_handler(self, user_input)
